		...
		<section id="three" class="wrapper" style="padding: 30px">
				<div class="inner">
					<header class="align-center">
						<h2><strong>매니저 계정 추가</strong></h2>
						<p>Insert manager information</p>
						...
						//String loginID = (String)session.getAttribute("id");
					            ...
					            String textare9 = "<td style=\"border: 0px;\"><input type=\"text\" name=\"mngnum\" size=\"5\" style=\"width:70%; height:70%; border: 0; \" required>";
					            ...
					            out.println("<tr><th>*매니저 번호</th>"+textare9+"</td><th>"+blank+"</th></tr>");
					            ...
					            /*out.println("<tr align=\"center\"><td>&nbsp;</td><td colspan=\"1\"><input type=button value=\"등록\"><td>&nbsp;</td></tr>");*/			
